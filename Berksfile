...
cookbook 'cop_php',      tag: '0.7.2',  github: 'copious-cookbooks/php'
cookbook 'cop_redis',    tag: '0.3.2',  github: 'copious-cookbooks/redis'
cookbook 'cop_users',    tag: '0.0.7',  github: 'copious-cookbooks/users'
cookbook 'cop_varnish',  tag: '2.0.1',  github: 'copious-cookbooks/varnish'
